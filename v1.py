...
OPTIMIZERS = {
    ...
    "sgd-025-0.9-nesterov": lambda: optimizers.SGD(lr=0.025, momentum=0.9, nesterov=True),
    "sgd-050-0.9-nesterov": lambda: optimizers.SGD(lr=0.050, momentum=0.9, nesterov=True),
    "sgd-075-0.9-nesterov": lambda: optimizers.SGD(lr=0.075, momentum=0.9, nesterov=True),
