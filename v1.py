...
OPTIMIZERS = {
    ...
    "sgd-0050-0.9-nesterov": lambda: optimizers.SGD(lr=0.0050, momentum=0.9, nesterov=True),
    "sgd-0075-0.9-nesterov": lambda: optimizers.SGD(lr=0.0075, momentum=0.9, nesterov=True),
